...
; 0000 0024     x = (x + 1) % 3;
	...
	CALL __MODW21
	MOV  R5,R30
; 0000 0025     a = PIND.0 * 1 + PIND.1 * 2 + PIND.2 * 4 + PIND.3 * 8 + PIND.4 * 16 + PIND.5 * 32 + PIND.6 * 64 + PIND.7 * 128;
	LDI  R26,0
	SBIC 0x10,0
	LDI  R26,1
	LDI  R30,LOW(1)
...
; 0000 0029     if (x == 0)
	...
	BRNE _0x3
; 0000 002A     {
; 0000 002B         PORTB = 0b0111;
	LDI  R30,LOW(7)
	OUT  0x18,R30
; 0000 002C         PORTC = code[b];
	MOVW R30,R8
...
_0x3:
	...
	BRNE _0x4
; 0000 0030     {
; 0000 0031         PORTB = 0b1011;
	LDI  R30,LOW(11)
	OUT  0x18,R30
; 0000 0032         PORTC = code[c];
	MOVW R30,R10
	SUBI R30,LOW(-_code*2)
	SBCI R31,HIGH(-_code*2)
	LPM  R0,Z
...
; 0000 004D // Mode: CTC top=OCR0
; 0000 004E // OC0 output: Disconnected
; 0000 004F // Timer Period: 0.128 ms
; 0000 0050 TCCR0=(0<<WGM00) | (0<<COM01) | (0<<COM00) | (1<<WGM01) | (1<<CS02) | (0<<CS01) | (1<<CS00);
	LDI  R30,LOW(13)
	OUT  0x33,R30
...
; 0000 0055 TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (0<<TOIE1) | (1<<OCIE0) | (0<<TOIE0);
	LDI  R30,LOW(2)
	OUT  0x39,R30
; 0000 0056 
